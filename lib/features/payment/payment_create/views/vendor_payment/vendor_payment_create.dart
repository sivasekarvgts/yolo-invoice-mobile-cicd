...
import 'vendor_payment_create_ctrl.dart';

class VendorPaymentCreate extends ConsumerStatefulWidget {
  const VendorPaymentCreate({super.key, this.input});

  final PaymentParamsRequestModel? input;

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _VendorPaymentCreateState();
}

class _VendorPaymentCreateState extends ConsumerState<VendorPaymentCreate> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      final controller = ref.read(vendorPaymentCreateCtrlProvider.notifier);
  ...
  Widget build(BuildContext context) {
    final controller = ref.watch(vendorPaymentCreateCtrlProvider.notifier);
    final state = ref.watch(vendorPaymentCreateCtrlProvider);
    ...
    return AppOverlayLoaderWidget(
      ...
      child: Scaffold(
        appBar: AppBarWidget.empty(
          ...
          title: 'Payment: #${controller.billNo ?? ''}',
          actions: [
            IconButton(
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: AppButton(
                        key: controller.isEdit ? Key("update_payment") : Key("save_payment"),
